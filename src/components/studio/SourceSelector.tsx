...
export const SourceSelector: React.FC<SourceSelectorProps> = ({
    ...
    // Render as a full-view replacement (Wizard style)
    return (
        <View className="flex-1 bg-space-light rounded-t-3xl overflow-hidden">
            <View className="flex-row items-center justify-between px-6 py-4 border-b border-white/10 bg-space-light">
            ...
            <View className="px-4 py-2 bg-space-light">
            ...
            {loading ? (
                <View className="flex-1 justify-center items-center bg-space-light">
            ...
            <View className="p-4 border-t border-white/10 bg-space-light">
                <Pressable
                    onPress={onClose}
